...
{
    //Derived from the Dbcontext
    public class CityInfoContext : DbContext
    {
        //Queries will be translated against the database.
        public DbSet<City> Cities { get; set;}

        public DbSet<PointOfInterest> PointOfInterest { get; set; }

        //Provide Context Options for connecting to the database.
        public CityInfoContext(DbContextOptions<CityInfoContext> options) : base(options)
        {

           // Database.EnsureCreated();//Ensures that the database is created if not already.
        }
